...
const projets = [
    ...
    },
    {
        ...
        category: 'fullStack',
        title: 'Dkr Services',
        description: "Plateforme de gestion pour une entreprise de nettoyage professionnel. Algorithme d'estimation de devis en temps réel, dashboard admin sécurisé pour la gestion des prospects, messages et demandes de services.",
    ...
    },
    {
        ...
        category: 'fullStack',
        title: 'CEGESINTL',
        description: "Plateforme web fullstack (SaaS/Vitrine) pour une entreprise du BTP. Interface réactive avec Vue.js + Laravel via Inertia.js (SPA). Système d'inscription pour un programme de logement, dashboard utilisateur et notifications email automatisées.",
